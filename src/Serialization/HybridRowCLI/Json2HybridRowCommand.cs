...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRowCLI
{
    ...
    public class Json2HybridRowCommand
    {
        ...
        public async Task<int> OnExecuteAsync()
        {
            ...
            await using Stream stm = new FileStream(this.JsonFile, FileMode.Open);
            ...
            switch (reader.TokenType)
            {
                ...
                case JsonToken.StartArray:
                {
                    ...
                    {
                        long totalWritten = 0;
                        Segment segment = new Segment("JSON conversion from HybridRowCLI json2hr", ns);
            ...
            switch (token.Type)
            {
                ...
                case JTokenType.Float:
                {
                    ...
                    try
                    {
                        return code switch
                        {
                            LayoutCode.Int8 => writer.WriteInt8(path, (sbyte)value),
                            LayoutCode.Int16 => writer.WriteInt16(path, (short)value),
                            LayoutCode.Int32 => writer.WriteInt32(path, (int)value),
                            LayoutCode.Int64 => writer.WriteInt64(path, (long)value),
                            LayoutCode.UInt8 => writer.WriteUInt8(path, (byte)value),
                            LayoutCode.UInt16 => writer.WriteUInt16(path, (ushort)value),
                            LayoutCode.UInt32 => writer.WriteUInt32(path, (uint)value),
                            LayoutCode.UInt64 => writer.WriteUInt64(path, (ulong)value),
                            LayoutCode.VarInt => writer.WriteVarInt(path, (long)value),
                            LayoutCode.VarUInt => writer.WriteVarUInt(path, (ulong)value),
                            LayoutCode.Float32 => writer.WriteFloat32(path, (float)value),
                            LayoutCode.Float64 => writer.WriteFloat64(path, value),
                            LayoutCode.Decimal => writer.WriteDecimal(path, (decimal)value),
                            LayoutCode.Utf8 => writer.WriteString(path, value.ToString(CultureInfo.InvariantCulture)),
                            _ => writer.WriteFloat64(path, value),
                        };
                    }
                    catch (OverflowException)
                    {
                ...
                case JTokenType.Boolean:
                {
                    ...
                    return code switch
                    {
                        LayoutCode.Int8 => writer.WriteInt8(path, (sbyte)(value ? 1 : 0)),
                        LayoutCode.Int16 => writer.WriteInt16(path, (short)(value ? 1 : 0)),
                        LayoutCode.Int32 => writer.WriteInt32(path, value ? 1 : 0),
                        LayoutCode.Int64 => writer.WriteInt64(path, value ? 1L : 0L),
                        LayoutCode.UInt8 => writer.WriteUInt8(path, (byte)(value ? 1 : 0)),
                        LayoutCode.UInt16 => writer.WriteUInt16(path, (ushort)(value ? 1 : 0)),
                        LayoutCode.UInt32 => writer.WriteUInt32(path, (uint)(value ? 1 : 0)),
                        LayoutCode.UInt64 => writer.WriteUInt64(path, value ? 1U : 0U),
                        LayoutCode.VarInt => writer.WriteVarInt(path, value ? 1L : 0L),
                        LayoutCode.VarUInt => writer.WriteVarUInt(path, value ? 1U : 0U),
                        LayoutCode.Float32 => writer.WriteFloat32(path, value ? 1 : 0),
                        LayoutCode.Float64 => writer.WriteFloat64(path, value ? 1 : 0),
                        LayoutCode.Decimal => writer.WriteDecimal(path, value ? 1 : 0),
                        LayoutCode.Utf8 => writer.WriteString(path, value ? "true" : "false"),
                        _ => writer.WriteBool(path, value),
                    };
                }
                ...
                case JTokenType.Null:
                    return code switch
                    {
                        LayoutCode.Null => writer.WriteNull(path),
                        LayoutCode.Invalid => writer.WriteNull(path),
                        _ => Result.Success
                    };
