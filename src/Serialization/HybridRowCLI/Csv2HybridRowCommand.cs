    ...
    public class Csv2HybridRowCommand
    {
        ...
        private static Result WriteField(ref RowWriter writer, Utf8String path, ReadOnlySpan<char> fieldValue)
        {
            ...
            switch (col?.Type?.LayoutCode ?? LayoutCode.Invalid)
            {
                ...
                {
                    if (!sbyte.TryParse(fieldValue.ToString(), out sbyte value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!short.TryParse(fieldValue.ToString(), out short value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!long.TryParse(fieldValue.ToString(), out long value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!byte.TryParse(fieldValue.ToString(), out byte value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!ushort.TryParse(fieldValue.ToString(), out ushort value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!uint.TryParse(fieldValue.ToString(), out uint value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!float.TryParse(fieldValue.ToString(), out float value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!double.TryParse(fieldValue.ToString(), out double value))
                    {
                        goto default;
                    }
                ...
                {
                    if (!decimal.TryParse(fieldValue.ToString(), out decimal value))
                    {
                        goto default;
                    }
                ...
                case LayoutCode.DateTime:
                {
                    ...
                    if (!DateTime.TryParse(fieldValue.ToString(), provider, style, out DateTime value))
                    {
                        goto default;
                    }
                ...
                case LayoutCode.Binary:
                {
                    try
                    {
                        byte[] newBytes = Convert.FromBase64String(fieldValue.ToString());
                ...
                default:
                    return writer.WriteString(path, fieldValue.ToString());
            }
        }

        private async Task<int> OnExecuteAsync()
        {
            (Namespace ns, LayoutResolver resolver) = await SchemaUtil.CreateResolverAsync(this.namespaceFile, this.verbose);
            MemorySpanResizer<byte> resizer = new MemorySpanResizer<byte>(Csv2HybridRowCommand.InitialCapacity);
            await using Stream stm = new FileStream(this.csvFile, FileMode.Open);
            ...
            long totalWritten = 0;
            Segment segment = new Segment("CSV conversion from HybridRowCLI csv2hr", ns);
