...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit
{
    ...
    {
        private const string SchemaFile = @"TestData\TaggedApiSchema.hrschema";
        ...
        {
            this.schema = SchemaUtil.LoadFromHrSchema(TaggedUnitTests.SchemaFile);
        ...
        private sealed class TaggedApi
        {
            ...
            {
                return System.HashCode.Combine(this.Tag1, this.Tag2);
            }
        }
    }
}
