                        ...
                        case 0 when key.Equals(GuestsHybridRowSerializer.AddressesName):
                            if (value != null)
                            {
                                ...
                                r = LayoutType.TypedMap.WriteScope(
                                    ...
                                    (ref RowBuffer row2, ref RowCursor childScope, (GuestsHybridRowSerializer This, List<object> Value) ctx) =>
                                    {
                                        foreach (object item in ctx.Value)
                                        {
                                            Result r2 = LayoutType.TypedTuple.WriteScope(
                                                ref row2,
                                                ref childScope,
                                                ctx.This.addresses.TypeArgs,
                                                (ctx.This, (List<object>)item),
                                                (ref RowBuffer row3, ref RowCursor tupleScope, (GuestsHybridRowSerializer This, List<object> Value) ctx2) =>
                                                {
                                                    ...
                                                    return LayoutType.ImmutableUDT.WriteScope(
                                                        ref row3,
                                                        ref tupleScope,
                                                        ctx2.This.addresses.TypeArgs[1].TypeArgs,
                                                        (Dictionary<Utf8String, object>)ctx2.Value[1],
                                                        ctx2.This.addressSerializerWriter);
                                                });
                                            if (r2 != Result.Success)
                                            {
                                                return r2;
