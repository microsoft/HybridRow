...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
    ...
    public sealed class Layout
    {
        ...
        public ColumnView Columns => new ColumnView(this.topColumns);
        ...
        /// <summary>Enumerates the columns of a <see cref="Layout" />.</summary>
        public struct ColumnView
        {
            ...
            /// <summary>Initializes a new instance of the <see cref="ColumnView" /> struct.</summary>
            ...
            public ColumnView GetEnumerator()
            {
                return new ColumnView(this.list);
            }
            ...
            /// <summary>Gets the element at the position indicated.</summary>
