...
public final class ProtobufRowGenerator {
    ...
    public void ReadBuffer(byte[] buffer) {
        switch (this.schemaName) {
            ...
            default:
                Contract.Fail(String.format("Unknown schema will be ignored: %1$s", this.schemaName));
                break;
        }
    }
    ...
    private static Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Address MakeAddress(HashMap<Utf8String, Object> tableValue) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Address address = new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Address();
    ...
    private static Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.PostalCode MakePostalCode(HashMap<Utf8String, Object> tableValue) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.PostalCode postalCode = new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.PostalCode();
        for ((Utf8String key,Object value) :tableValue)
        {
            switch (key.toString()) {
                case "zip":
    ...
    private static void PopulateStringAddressMap(MapField<String,
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Address> field,
                                                 ArrayList<Object> list) {
        for (Object item : list) {
            ArrayList<Object> tuple = (ArrayList<Object>)item;
            String key = ((Utf8String)tuple.get(0)).toString();
            Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Address value =
    ...
    private static void ReadBufferGuest(byte[] buffer) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Guests item =
            new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Guests();
    ...
    private static void ReadBufferHotel(byte[] buffer) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Hotels item =
            new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Hotels();
        item.MergeFrom(buffer);
    }
    ...
    private static void ReadBufferRoom(byte[] buffer) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Available_Rooms_By_Hotel_Date item = new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Available_Rooms_By_Hotel_Date();
        item.MergeFrom(buffer);
    }

    private void WriteBufferGuest(HashMap<Utf8String, Object> tableValue) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Guests room =
            new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Guests();
    ...
    private void WriteBufferHotel(HashMap<Utf8String, Object> tableValue) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Hotels room =
            new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Hotels();
        try (CodedOutputStream stm = new CodedOutputStream(this.buffer)) {
            for ((Utf8String key,Object value) :tableValue)
            {
    ...
    private void WriteBufferRoom(HashMap<Utf8String, Object> tableValue) {
        Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Available_Rooms_By_Hotel_Date room = new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.Available_Rooms_By_Hotel_Date();
        try (CodedOutputStream stm = new CodedOutputStream(this.buffer)) {
            for ((Utf8String key,Object value) :tableValue)
            {
                switch (key.toString()) {
