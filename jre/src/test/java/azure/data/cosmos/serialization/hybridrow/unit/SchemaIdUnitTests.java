...
public class SchemaIdUnitTests {
    ...
    public final void SchemaIdTest() {
        ...
        assert azure.data.cosmos.serialization.hybridrow.SchemaId.opEquals(a.clone(), a.clone());
        assert azure.data.cosmos.serialization.hybridrow.SchemaId.opNotEquals(a.clone(), b.clone());
