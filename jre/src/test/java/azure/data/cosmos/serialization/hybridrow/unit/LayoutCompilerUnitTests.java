...
public class LayoutCompilerUnitTests {
    ...
    public final void ParseSchemaFixed() {
        ...
        RoundTripFixed.Expected[] expectedSchemas =
            new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripFixed.Expected[] { tempVar, tempVar2, tempVar3, tempVar4, tempVar5, tempVar6, tempVar7, tempVar8, tempVar9, tempVar10, tempVar11, tempVar12, tempVar13, tempVar14, tempVar15, tempVar16, tempVar17, tempVar18, tempVar19, tempVar20 };
...
public final void ParseSchemaVariable()
    ...
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripVariable.Expected[]{tempVar,tempVar2,tempVar3,tempVar4};
...
public final void SparseOrdering()
    ...
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseOrdering.Expected[][]
    {
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseOrdering.Expected[]{tempVar,tempVar2},
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseOrdering.Expected[]{tempVar3,tempVar4},
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseOrdering.Expected[]{tempVar5,tempVar6,tempVar7,tempVar8}
    };
...
public final void ParseSchemaSparseObject()
    ...
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObject.Expected[]{tempVar};
...
public final void ParseSchemaSparseObjectMulti()
    ...
    tempVar.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectMulti.Property[]{tempVar2};
    ...
    tempVar5.Value="abc";
    tempVar3.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectMulti.Property[]{tempVar4,tempVar5};
    ...
    tempVar6.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectMulti.Property[]{tempVar7,tempVar8,tempVar9,tempVar10};
    ...
    tempVar11.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectMulti.Property[]{tempVar12};
    RoundTripSparseObjectMulti.Expected[]expectedSchemas=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectMulti.Expected[]{tempVar,tempVar3,tempVar6,tempVar11};
...
public final void ParseSchemaSparseObjectNested()
    ...
    tempVar2.Value=(byte)42;
    tempVar.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectNested.Property[]{tempVar2};
    ...
    tempVar5.Value="abc";
    tempVar3.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectNested.Property[]{tempVar4,tempVar5};
    ...
    tempVar10.Value=NullValue.Default;
    tempVar6.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectNested.Property[]{tempVar7,tempVar8,tempVar9,tempVar10};
    ...
    tempVar11.Props=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectNested.Property[]{tempVar12};
    RoundTripSparseObjectNested.Expected[]expectedSchemas=
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseObjectNested.Expected[]{tempVar,tempVar3,tempVar6,tempVar11};
...
public final void ParseSchemaSparseArray()
    ...
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseArray.Expected[]{tempVar,tempVar2,tempVar3,tempVar4,tempVar5,tempVar6,tempVar7,tempVar8,tempVar9,tempVar10,tempVar11,tempVar12,tempVar13,tempVar14,tempVar15,tempVar16,tempVar17,tempVar18,tempVar19,tempVar20,tempVar21,tempVar22};
...
public final void ParseSchemaSparseSet()
    ...
    new Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Unit.LayoutCompilerUnitTests.RoundTripSparseSet.Expected[]{tempVar,tempVar2,tempVar3,tempVar4,tempVar5,tempVar6,tempVar7,tempVar8,tempVar9,tempVar10,tempVar11,tempVar12,tempVar13,tempVar14,tempVar15,tempVar16,tempVar17,tempVar18,tempVar19};
...
private<TDispatcher extends TestActionDispatcher<TClosure>, TClosure> void LayoutCodeSwitch(LayoutCode code,
    ...
    break;
default:
    Contract.Assert(false,String.format("Unknown type will be ignored: %1$s",code));
    break;
    }
    }
...
private final static class RoundTripFixed extends TestActionDispatcher<RoundTripFixed.Closure> {
    @Override
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
                                           Closure closure) {
        ...
        if (azure.data.cosmos.serialization.hybridrow.layouts.LayoutBit.opNotEquals(col.getNullBit().clone(),
            LayoutBit.Invalid)) {
        ...
        root.argValue.AsReadOnly(out roRoot);
...
private final static class RoundTripSparseArray extends TestActionDispatcher<RoundTripSparseArray.Closure> {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        azure.data.cosmos.serialization.hybridrow.layouts.LayoutType tempVar = arrCol.getType();
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.Clone(out field).Find(row, arrCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor scope;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        ...
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field2 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor scope2;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope2 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = arrT.ReadScope(row, tempRef_field2, tempOut_scope2);
        scope2 = tempOut_scope2.argValue;
        field = tempRef_field2.argValue;
        ResultAssert.IsSuccess(r, tag);
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.AsReadOnly(out roRoot).Find(row, arrCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_roRoot =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(roRoot);
        ResultAssert.InsufficientPermissions(arrT.DeleteScope(row, tempRef_roRoot));
        roRoot = tempRef_roRoot.argValue;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'ref' keyword - these
        // cannot be converted using the 'RefObject' helper class unless the method is within the code being modified:
        ...
        // Overwrite the whole scope.
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field3 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = LayoutType.Null.WriteSparse(row, tempRef_field3, NullValue.Default);
        field = tempRef_field3.argValue;
        ResultAssert.IsSuccess(r, tag);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field4 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        ...
        field = tempRef_field4.argValue;
        ResultAssert.TypeMismatch(r, tag);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field5 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = arrT.DeleteScope(row, tempRef_field5);
        field = tempRef_field5.argValue;
        ResultAssert.TypeMismatch(r, "Json: {0}", expected.Json);
        ...
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field6 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = arrT.DeleteScope(row, tempRef_field6);
        field = tempRef_field6.argValue;
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field7 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut__2 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = arrT.ReadScope(row, tempRef_field7, tempOut__2);
        _ = tempOut__2.argValue;
        field = tempRef_field7.argValue;
        ResultAssert.NotFound(r, "Json: {0}", expected.Json);
    }
...
private final static class RoundTripSparseObject extends TestActionDispatcher<RoundTripSparseObject.Closure> {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        azure.data.cosmos.serialization.hybridrow.layouts.LayoutType tempVar = objCol.getType();
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.Clone(out field).Find(row, objCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor scope;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope =
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.AsReadOnly(out roRoot).Find(row, objCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_roRoot =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(roRoot);
        ResultAssert.InsufficientPermissions(objT.DeleteScope(row, tempRef_roRoot));
        roRoot = tempRef_roRoot.argValue;
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_roRoot2 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(roRoot);
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope22 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        ResultAssert.InsufficientPermissions(objT.WriteScope(row, tempRef_roRoot2, objCol.getTypeArgs().clone(),
            tempOut_scope22));
        scope2 = tempOut_scope22.argValue;
        roRoot = tempRef_roRoot2.argValue;
        ...
        field = tempRef_field7.argValue;
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field8 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = objT.DeleteScope(row, tempRef_field8);
        field = tempRef_field8.argValue;
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field9 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut__3 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = objT.ReadScope(row, tempRef_field9, tempOut__3);
        _ = tempOut__3.argValue;
        field = tempRef_field9.argValue;
        ResultAssert.NotFound(r, "Json: {0}", expected.Json);
    }
...
private final static class RoundTripSparseObjectMulti extends TestActionDispatcher<RoundTripSparseObjectMulti.Closure> {
    @Override
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> scope,
                                           Closure closure) {
        LayoutColumn col = closure.Col;
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        scope.argValue.Clone(out nestedField).Find(row, col.getPath());
        TValue value;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'ref' keyword - these
        ...
        if (t instanceof LayoutNull) {
            tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_nestedField =
                new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(nestedField);
            r = LayoutType.Boolean.WriteSparse(row, tempRef_nestedField, false);
            nestedField = tempRef_nestedField.argValue;
            ResultAssert.IsSuccess(r, tag);
        } else {
            tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_nestedField2 =
                new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(nestedField);
            r = LayoutType.Null.WriteSparse(row, tempRef_nestedField2, NullValue.Default);
            nestedField = tempRef_nestedField2.argValue;
            ResultAssert.IsSuccess(r, tag);
        }
    ...
    @Override
    public void DispatchObject(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> scope,
                               Closure closure) {
        LayoutColumn col = closure.Col;
        Property prop = closure.Prop.clone();
        Expected expected = closure.Expected.clone();
        ...
        // Read the nested field
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_nestedField3 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(nestedField);
        RowCursor scope3;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope3 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = t.ReadScope(row, tempRef_nestedField3, tempOut_scope3);
        scope3 = tempOut_scope3.argValue;
        nestedField = tempRef_nestedField3.argValue;
        ResultAssert.IsSuccess(r, tag);
        RowCursor _;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        ...
        // Overwrite the nested field.
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_nestedField4 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(nestedField);
        r = LayoutType.Null.WriteSparse(row, tempRef_nestedField4, NullValue.Default);
        nestedField = tempRef_nestedField4.argValue;
        ResultAssert.IsSuccess(r, tag);

        // Verify nested field no longer there.
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_nestedField5 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(nestedField);
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope32 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = t.ReadScope(row, tempRef_nestedField5, tempOut_scope32);
        scope3 = tempOut_scope32.argValue;
        nestedField = tempRef_nestedField5.argValue;
        ResultAssert.TypeMismatch(r, tag);
    }
...
private final static class RoundTripSparseObjectNested extends TestActionDispatcher<RoundTripSparseObjectNested.Closure> {
    ...
    @Override
    public void DispatchObject(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root, Closure closure) {
        LayoutColumn col = closure.Col;
        Property prop = closure.Prop.clone();
        Expected expected = closure.Expected.clone();
        String tag = String.format("Prop: %2$s: Json: %1$s", expected.Json, prop.Path);
        ...
        assert root.argValue.clone() != scope.clone();
    }
...
private final static class RoundTripSparseOrdering extends TestActionDispatcher<RoundTripSparseOrdering.Closure> {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.Clone(out field).Find(row, path);
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'ref' keyword - these
        // cannot be converted using the 'RefObject' helper class unless the method is within the code being modified:
...
private final static class RoundTripSparseSet extends TestActionDispatcher<RoundTripSparseSet.Closure> {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        azure.data.cosmos.serialization.hybridrow.layouts.LayoutType tempVar = setCol.getType();
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.Clone(out field).Find(row, setCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor scope;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope =
        ...
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field5 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope4 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        ResultAssert.IsSuccess(setT.ReadScope(row, tempRef_field5, tempOut_scope4));
        scope = tempOut_scope4.argValue;
        field = tempRef_field5.argValue;
        ...
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field6 =
            new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope5 =
            new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        ResultAssert.IsSuccess(setT.ReadScope(row, tempRef_field6, tempOut_scope5));
        scope = tempOut_scope5.argValue;
        field = tempRef_field6.argValue;
        for (Object item : expected.Value) {
            assert scope.MoveNext(row);
            // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        ...
        if (expected.Value.size() > 1) {
            ...
            tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field7 =
                new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope6 = new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
            ResultAssert.IsSuccess(setT.ReadScope(row, tempRef_field7, tempOut_scope6));
            scope = tempOut_scope6.argValue;
            field = tempRef_field7.argValue;
            ...
            tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field8 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut_scope7 = new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
            ResultAssert.IsSuccess(setT.ReadScope(row, tempRef_field8, tempOut_scope7));
            scope = tempOut_scope7.argValue;
            field = tempRef_field8.argValue;
            for (Object item : remainingValues) {
                assert scope.MoveNext(row);
        ...
        RowCursor roRoot;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.AsReadOnly(out roRoot).Find(row, setCol.getPath());
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_roRoot = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(roRoot);
        ...
        // Overwrite the whole scope.
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field9 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = LayoutType.Null.WriteSparse(row, tempRef_field9, NullValue.Default);
        field = tempRef_field9.argValue;
        ResultAssert.IsSuccess(r, tag);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field10 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut__ = new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = setT.ReadScope(row, tempRef_field10, tempOut__);
        _ = tempOut__.argValue;
        field = tempRef_field10.argValue;
        ResultAssert.TypeMismatch(r, tag);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field11 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = setT.DeleteScope(row, tempRef_field11);
        field = tempRef_field11.argValue;
        ResultAssert.TypeMismatch(r, "Json: {0}", expected.Json);

        // Overwrite it again, then delete it.
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field12 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        r = setT.WriteScope(row, tempRef_field12, setCol.getTypeArgs().clone(), out _, UpdateOptions.Update);
        field = tempRef_field12.argValue;
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field13 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        r = setT.DeleteScope(row, tempRef_field13);
        field = tempRef_field13.argValue;
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempRef_field14 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.RowCursor>(field);
        RowCursor _;
        tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor> tempOut__2 = new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.RowCursor>();
        r = setT.ReadScope(row, tempRef_field14, tempOut__2);
        _ = tempOut__2.argValue;
        field = tempRef_field14.argValue;
        ResultAssert.NotFound(r, "Json: {0}", expected.Json);
    }
...
private final static class RoundTripSparseSimple extends TestActionDispatcher<RoundTripSparseSimple.Closure> {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.Clone(out field).Find(row, col.getPath());
        TValue value;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'ref' keyword - these
        ...
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        root.argValue.AsReadOnly(out roRoot).Find(row, col.getPath());
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'ref' keyword - these
        // cannot be converted using the 'RefObject' helper class unless the method is within the code being modified:
...
private static class RoundTripVariable extends TestActionDispatcher<RoundTripVariable.Closure> {
    ...
    protected final <TLayout extends LayoutType<TValue>, TValue> void Compare(tangible.RefObject<RowBuffer> row,
                                                                              tangible.RefObject<RowCursor> root, LayoutColumn col, Object exValue, Expected expected) {
        TLayout t = (TLayout)col.getType();
        TValue value;
        tangible.OutObject<TValue> tempOut_value = new tangible.OutObject<TValue>();
    ...
    protected final <TLayout extends LayoutType<TValue>, TValue> void RoundTrip(tangible.RefObject<RowBuffer> row,
                                                                                tangible.RefObject<RowCursor> root, LayoutColumn col, Object exValue, Expected expected) {
        TLayout t = (TLayout)col.getType();
...
private abstract static class TestActionDispatcher<TClosure> {
    public abstract <TLayout extends LayoutType<TValue>, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> scope, TClosure closure);

    public void DispatchObject(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> scope, TClosure closure) {
...
private final static class VariableInterleaving extends RoundTripVariable {
    ...
    public <TLayout, TValue> void Dispatch(tangible.RefObject<RowBuffer> row, tangible.RefObject<RowCursor> root,
        ...
        int rowSizeBeforeShrink = row.argValue.getLength();
        ...
        int rowSizeAfterShrink = row.argValue.getLength();
        ...
        this.<TLayout, TValue>Compare(row, root, c, expected.Value, expected.clone());
        int rowSizeAfterGrow = row.argValue.getLength();
    ...
    private <TLayout extends LayoutType<TValue>, TValue> void Delete(tangible.RefObject<RowBuffer> row,
                                                                     tangible.RefObject<RowCursor> root, LayoutColumn col, Expected expected) {
        TLayout t = (TLayout)col.getType();
        RowCursor roRoot;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
        ...
        ResultAssert.IsSuccess(r, "Json: {0}", expected.Json);
        TValue _;
        tangible.OutObject<TValue> tempOut__ = new tangible.OutObject<TValue>();
        r = t.ReadVariable(row, root, col, tempOut__);
        _ = tempOut__.argValue;
        ResultAssert.NotFound(r, "Json: {0}", expected.Json);
    }

    private <TLayout extends LayoutType<TValue>, TValue> void TooBig(tangible.RefObject<RowBuffer> row,
                                                                     tangible.RefObject<RowCursor> root, LayoutColumn col, Expected expected) {
        TLayout t = (TLayout)col.getType();
    ...
    private <TLayout extends LayoutType<TValue>, TValue> LayoutColumn Verify(tangible.RefObject<RowBuffer> row,
                                                                             tangible.RefObject<RowCursor> root, Layout layout, String path, Expected expected) {
        LayoutColumn col;
        // TODO: C# TO JAVA CONVERTER: The following method call contained an unresolved 'out' keyword - these
        // cannot be converted using the 'OutObject' helper class unless the method is within the code being modified:
