...
public final class PostalCode implements Google.Protobuf.IMessage<PostalCode> {
    /**
    ...
    private static final Google.Protobuf.MessageParser<PostalCode> _parser =
        new Google.Protobuf.MessageParser<PostalCode>(() -> new PostalCode());
    ...
    public static Google.Protobuf.Reflection.MessageDescriptor getDescriptor() {
        return Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.CassandraHotelSchemaReflection.getDescriptor().MessageTypes[0];
    }
