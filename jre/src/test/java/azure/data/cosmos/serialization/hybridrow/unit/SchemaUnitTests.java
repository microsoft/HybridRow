...
public class SchemaUnitTests {
    ...
    public final void ParseNamespace() {
...

        {
            ...
            class AnonymousType {
                public String Path;
                public Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.StorageKind Storage;
                public Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind Type;

                public AnonymousType(String _Path,
                                     Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type,
                                     Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.StorageKind _Storage) {
                    Path = _Path;
                    Type = _Type;
                    Storage = _Storage;
                }
...
// TODO: C# TO JAVA CONVERTER: Java annotations will not correspond to .NET attributes:
    ...
    public final void ParseSchemaPrimitives() {
        ...
        class AnonymousType {
            ...
            public AnonymousType(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType2 {
            ...
            public AnonymousType2(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType20 {
            ...
            public AnonymousType20(String _Json,
                                   Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type, int _Len) {
                Json = _Json;
                Type = _Type;
                Len = _Len;
            }
        ...
        class AnonymousType3 {
            ...
            public AnonymousType3(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType4 {
            ...
            public AnonymousType4(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType5 {
            ...
            public AnonymousType5(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType6 {
            ...
            public AnonymousType6(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType7 {
            ...
            public AnonymousType7(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType8 {
            ...
            public AnonymousType8(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
        ...
        class AnonymousType9 {
            ...
            public AnonymousType9(String _Json, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypeKind _Type) {
                Json = _Json;
                Type = _Type;
            }
        }
...
class AnonymousType2 {
    public Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.SortDirection Dir;

    pulic String Path

    pubblic AnonymousType2(String _Path, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.SortDirection _Dir) {
        Path = _Path;
        Dir = _Dir;
    }
}
...
class AnonymousType3 {
    ...
    pubblct[] expectedSchemas = new Object[] { AnonymousType("{'path': 'a'}", "{'path': 'b', 'direction': 'desc'}, " +
		...
		for(bjeic AnonymousType3(String _Path, Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.SortDirection _Dir) {
        Path = _Path;
        Dir = _Dir;
    }
}
