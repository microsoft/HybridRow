...
public final class RowWriterUnitTests {
    ...
    public void WriteMixed() {
                                                                         ...
                                                                         TypeArgument rootTypeArg, Object ignored) ->
        {
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col2 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("array_t<array_t<float32>>", tempOut_col2);
            col = tempOut_col2.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col3 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("array_t<utf8>", tempOut_col3);
            col = tempOut_col3.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col4 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("tuple<varint,int64>", tempOut_col4);
            col = tempOut_col4.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col5 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("tuple<null,tuple<int8,int8>>", tempOut_col5);
            col = tempOut_col5.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(),
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col6 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("tuple<bool,udt>", tempOut_col6);
            col = tempOut_col6.argValue;
                ...
                RowReaderUnitTests.Point> values) ->
            {
                ...
                tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowWriter> tempRef_writer3 =
                    new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowWriter>(writer3);
                ResultAssert.IsSuccess(writer2.WriteScope(null, typeArg.getTypeArgs().get(1).clone(), values.Item2,
                    (ref RowWriter writer3, TypeArgument typeArg2, IRowSerializable values2) -> values2.Write(tempRef_writer3, typeArg2.clone())));
                writer3 = tempRef_writer3.argValue;

                return Result.Success;
            }));

            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col7 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("nullable<int32,int64>", tempOut_col7);
            col = tempOut_col7.argValue;
            ...
            {
                RowWriter.WriterFunc<Integer> f0 = (tangible.RefObject<RowWriter> writer, TypeArgument typeArg,
                ...
                RowWriter.WriterFunc<Long> f1 = (tangible.RefObject<RowWriter> writer, TypeArgument typeArg,
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col8 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("tagged<utf8>", tempOut_col8);
            col = tempOut_col8.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col9 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("tagged<bool,utf8>", tempOut_col9);
            col = tempOut_col9.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col10 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("set_t<utf8>", tempOut_col10);
            col = tempOut_col10.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(), new String[] { "abc",
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col11 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("set_t<array_t<int8>>", tempOut_col11);
            col = tempOut_col11.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col12 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("set_t<set_t<int32>>", tempOut_col12);
            col = tempOut_col12.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col13 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("set_t<udt>", tempOut_col13);
            col = tempOut_col13.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(),
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col14 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("map_t<utf8,utf8>", tempOut_col14);
            col = tempOut_col14.argValue;
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col15 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("map_t<int8,array_t<int8>>", tempOut_col15);
            col = tempOut_col15.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(), new System.Tuple<T1,
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col16 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("map_t<int16,map_t<int32,int32>>", tempOut_col16);
            col = tempOut_col16.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(), new System.Tuple<T1,
            ...
            tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn> tempOut_col17 =
                new tangible.OutObject<azure.data.cosmos.serialization.hybridrow.layouts.LayoutColumn>();
            assert layout.TryFind("map_t<float64,udt>", tempOut_col17);
            col = tempOut_col17.argValue;
            ResultAssert.IsSuccess(writer.WriteScope(col.getPath(), col.getTypeArg().clone(), new System.Tuple<T1, T2>[] { Tuple.Create(1.0, new RowReaderUnitTests.Point(1, 2)), Tuple.Create(2.0, new RowReaderUnitTests.Point(3, 4)), Tuple.Create(3.0, new RowReaderUnitTests.Point(5, 6)) }, (ref RowWriter writer2, TypeArgument typeArg, Tuple<Double, RowReaderUnitTests.Point>[] values) ->
            {
                for (Tuple<Double, RowReaderUnitTests.Point> value : values) {
                    ResultAssert.IsSuccess(writer2.WriteScope(null, new TypeArgument(LayoutType.TypedTuple, typeArg.getTypeArgs().clone()), value, (ref RowWriter writer3, TypeArgument typeArg2, Tuple<Double, RowReaderUnitTests.Point> values2) ->
                    {
                        ...
                        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowWriter> tempRef_writer4 = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowWriter>(writer4);
                        ...
                        writer4 = tempRef_writer4.argValue;
        ...
        tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowReader> tempRef_reader = new tangible.RefObject<azure.data.cosmos.serialization.hybridrow.io.RowReader>(reader);
