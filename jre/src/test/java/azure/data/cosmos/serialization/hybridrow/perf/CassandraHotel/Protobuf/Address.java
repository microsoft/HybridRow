...
public final class Address implements Google.Protobuf.IMessage<Address> {
    /**
    ...
    private static final Google.Protobuf.MessageParser<Address> _parser =
		new Google.Protobuf.MessageParser<Address>(() -> new Address());
    private static final Google.Protobuf.FieldCodec<String> _single_city_codec =
    ...
    public static Google.Protobuf.Reflection.MessageDescriptor getDescriptor() {
        return Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.CassandraHotel.Protobuf.CassandraHotelSchemaReflection.getDescriptor().MessageTypes[1];
    }
