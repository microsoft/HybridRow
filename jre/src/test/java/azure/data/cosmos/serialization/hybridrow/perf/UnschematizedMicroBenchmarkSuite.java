...
public final class UnschematizedMicroBenchmarkSuite extends MicroBenchmarkSuiteBase {
    ...
    private static void BsonReadBenchmark(String dataSetName, int innerLoopIterations, ArrayList<HashMap<Utf8String,
        ...
        try (BsonJsonModelRowGenerator writer = new BsonJsonModelRowGenerator(BenchmarkSuiteBase.InitialCapacity)) {
        ...
        tangible.RefObject<Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.MicroBenchmarkSuiteBase.BenchmarkContext> tempRef_ignoredContext = new tangible.RefObject<Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.MicroBenchmarkSuiteBase.BenchmarkContext>(ignoredContext);
        ...
        MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Read", dataSetName, "BSON", innerLoopIterations, tempRef_ignoredContext, (ref BenchmarkContext _, byte[] tableValue) ->
        {
        ...
        ignoredContext = tempRef_ignoredContext.argValue;
    }
    ...
    private static void BsonWriteBenchmark(String dataSetName, int innerLoopIterations, ArrayList<HashMap<Utf8String,
        ...
        try (BsonJsonModelRowGenerator writer = new BsonJsonModelRowGenerator(BenchmarkSuiteBase.InitialCapacity)) {
            ...
            MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Write", dataSetName, "BSON", innerLoopIterations,
    ...
    private static void JsonModelReadBenchmark(LayoutResolverNamespace resolver, String schemaName,
        ...
        context.JsonModelWriter = new JsonModelRowGenerator(BenchmarkSuiteBase.InitialCapacity, layout, resolver);
        ...
        tangible.RefObject<Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.MicroBenchmarkSuiteBase.BenchmarkContext> tempRef_context = new tangible.RefObject<Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.MicroBenchmarkSuiteBase.BenchmarkContext>(context);
        ...
        MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Read", dataSetName, "HybridRowSparse",
            innerLoopIterations, tempRef_context, (ref BenchmarkContext ctx, byte[] tableValue) ->
        {
            ...
            Microsoft.Azure.Cosmos.Serialization.HybridRow.Tests.Perf.RowReaderExtensions.VisitReader(reader.clone());
        }, (ref BenchmarkContext ctx, byte[] tableValue) -> tableValue.length, expectedSerialized);
        context = tempRef_context.argValue;
    }
    ...
    private static void JsonModelWriteBenchmark(LayoutResolverNamespace resolver, String schemaName,
        ...
        // TODO: C# TO JAVA CONVERTER: The following lambda contained an unresolved 'ref' keyword - these are not
        // converted by C# to Java Converter:
        MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Write", dataSetName, "HybridRowSparse",
    ...
    private static void JsonReadBenchmark(String dataSetName, int innerLoopIterations, ArrayList<HashMap<Utf8String,
        ...
        MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Read", dataSetName, "JSON", innerLoopIterations,
        ...
        try (MemoryStream jsonStream = new MemoryStream(BenchmarkSuiteBase.InitialCapacity)) {
            try (OutputStreamWriter textWriter = new OutputStreamWriter(jsonStream)) {
                try (JsonTextWriter jsonWriter = new JsonTextWriter(textWriter)) {
                    ...
                    MicroBenchmarkSuiteBase.Benchmark("Unschematized", "Write", dataSetName, "JSON",
